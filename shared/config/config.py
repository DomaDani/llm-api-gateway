...
DASHBOARD_BACKEND_PORT = int(os.getenv("DASHBOARD_BACKEND_PORT", 8080))
DASHBOARD_FRONTEND_PORT = int(os.getenv("DASHBOARD_FRONTEND_PORT", 5173))
ADMINISTRATOR_USERNAME = os.getenv("ADMINISTRATOR_USERNAME", "Administrator")
ADMINISTRATOR_EMAIL = os.getenv("ADMINISTRATOR_EMAIL", "admin@example.com")
