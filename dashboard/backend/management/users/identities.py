...
from dashboard.backend.db import user_email_free, user_username_free, get_user_permissions_for_project, is_user_administrator, is_user_project_manager
...
async def convert_orm_to_display_info(user_orm: User, include_role: bool = False, project_id: int | None = None) -> UserDisplayInfo:
