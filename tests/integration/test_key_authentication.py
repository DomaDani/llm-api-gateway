...
def test_key_authentication(completions_url: str, expired_api_key: str, completions_dir: Path):
    ...
    clinet = OpenAI(api_key="TooShortKey", base_url=completions_url)
    ...
    client = OpenAI(api_key="TooLongKeyTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT", base_url=completions_url)
    ...
    client = OpenAI(api_key="InvalidKeyTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT", base_url=completions_url)
    chat_completion = client.chat.completions.create(**request_data)
    ...
    client = OpenAI(api_key=expired_api_key, base_url=completions_url)
    chat_completion = client.chat.completions.create(**request_data)
    ...
    client = OpenAI(api_key="TTcj1lxYOY9dInvalidWithMatchingFingerprintTTTTTTTTTTTTTTTTTTTTTT", base_url=completions_url)
    chat_completion = client.chat.completions.create(**request_data)
